...
class _RetrofitApiService implements RetrofitApiService {
  _RetrofitApiService(
    this._dio, {
    this.baseUrl,
  }) {
  ...
  @override
  Future<WebtoonDetail> getToonById(String id) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final Map<String, dynamic>? _data = null;
  ...
  @override
  Future<List<WebtoonEpisode>> getLatestEpisodesById(String id) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final Map<String, dynamic>? _data = null;
